    ...
    <main className="about-us-main-container">
      <div className="about-us-content-wrapper">
        <div className="about-us-team">
          ...
          <p>
            Our team worked on developing a website for an online store that
            sells holiday goods. The development was carried out as part of the
            task of the{' '}
            <a
              ...
              <div className="about-us-description">
                ...
                <div>
                  ...
                  <ul>
                    ...
                    <li>
                      integrating promocodes from commercetools into the
                      project,
                    </li>
